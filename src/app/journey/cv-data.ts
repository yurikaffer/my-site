export const expItems = [
    {
        ...
        items: ['Desenvolvimento de chatbots e URAs eletrônicas como solução omnichannel.',
        ...
        items: ['Desenvolvimento de correções emergenciais no time de complexidade técnica.',
        ...
        items: ['Atendimento, análise e solução de problemas técnicos reportados pelo cliente no time de Suporte técnico.',
...
export const skillItems = [
    {
        ...
        skills: "TypeScript, JavaScript, Java, DataFlex, Python, HTML, e CSS."
    },
    {
        title: "Libs & Frameworks",
        skills: "React.js, Next.js, Nest.js, Adonis.js, Node.js, Tailwindcss, Material UI e nextUI."
    },
    {
        title: "Banco de dados",
        skills: "SQL, MySQL, Oracle e MongoDB."
    },
    {
        title: "Provedores",
        skills: "Vercel, AWS, Firebase, Google Cloud, Github, GitLab e Tortoise."
    },
    {
        title: "Ferramentas",
        skills: "VSCode, Intellij Idea, Eclipse, Git, Yarn, NPM, Figma, Postman, MS Office, e Dev Tools."
    }
]
...
export const certificateItems = [
    { institution: "Udemy", name: "Java COMPLETO Programação Orientada a Objetos + Projetos" },
    { institution: "Udemy", name: "Curso Web Moderno Completo com JavaScript + Projetos" },
    { institution: "Udemy", name: "Formação Cientista de Dados: O Curso Completo" },
    { institution: "Udemy", name: "GERENCIAMENTO POR PROCESSOS DE NEGÓCIO (BPM) CONFORME O CBOK" }
]
