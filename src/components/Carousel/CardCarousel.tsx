...
function CardCarousel({ activeButton }: CardCarouselProps) {
    ...
    return (
        <div>
            <div className="custom-scroll2 flex overflow-x-auto gap-4 py-[1rem] lg:overflow-x-hidden" ref={carouselRef}>
...
function CardProject({ img, title, description, tags, git, demo, style }: CardProjectProps) {
    return (
        <div className={`${style} animate-entrance flex flex-col animate-in min-w-[21rem] min-h-[29rem] lg:max-w-[25rem] lg:min-w-[26rem] p-[1rem] rounded-large transition duration-custom lg:hover:-translate-y-3 `}>
