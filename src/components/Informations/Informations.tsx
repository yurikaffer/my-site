      ...
      <div className="w-full h-full sm:pt-[2rem] max-w-[35rem] pr-[1rem] xl:pt-0 xl:max-w-none">
        <div className="flex flex-col gap-6 ">
          <div className="flex justify-between leading-tight">
            ...
            <div className="flex flex-col  ">
              <span className="gradient-text text-[38px] md:text-md font-extrabold tracking-tight self-center">1</span>
              <p className="text-text self-center" >Gatinho fofinho</p>
            </div>
            <div className="flex flex-col  ">
          ...
          <p className="text-text" >
            Eu digo que desde que entendi a da programação, ela tem mudado minha vida. A princípio no âmbito profissional, 
          ...
          <div className="flex flex-col">
            ...
            <p className="text-text italic self-end pr-3" >
              - Yuri Kaffer.
            </p>
          </div>
        </div>
